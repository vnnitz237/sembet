...
/**
 * ScreenHome — main app home screen.
 *
 * Exposes via ref:
 *  - protectionCardEl  the "Proteção ativa" status card (Act 3 highlight target)
 *  - screenContentEl   wrapper over dimable content (Act 3 brightness filter)
 */
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 16px 4px' }}>
        <span style={{ fontSize: '13px', fontWeight: 800, color: '#172b3a', letterSpacing: '-0.03em' }}>
          SemBet
        </span>
        <Bell size={13} color="#607789" aria-hidden />
      </div>

      {/* Scrollable content wrapper — dimmed in Act 3 via filter */}
      <div
      ...
      >
        ...
        {/* ── "Proteção ativa" card — Act 3 highlight target ── */}
        <div
        ...
        >
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '38px', fontWeight: 800, color: '#172b3a', lineHeight: 1, letterSpacing: '-0.04em' }}>
              18
            </div>
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                borderRadius: '9px', padding: '7px 8px',
                border: '1px solid rgba(49,138,199,0.08)', textAlign: 'center',
              }}
            >
      ...
      >
        {NAV_ITEMS.map(({ Icon, label, active }) => (
          ...
          >
            ...
            <span style={{ fontSize: '8px', color: active ? '#318ac7' : '#9ab0be', fontWeight: active ? 700 : 400 }}>
              {label}
            </span>
          </div>
        ))}
